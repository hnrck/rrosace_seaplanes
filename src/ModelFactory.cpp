...
template <> UpModel ModelFactory::Generate<RROSACE::Engine, 1>() {
  ...
  values.delta_th_c_status.subscribe = 1;
  values.t_status.publish = 1;
...
template <> UpModel ModelFactory::Generate<RROSACE::Elevator, 1>() {
  auto &&values = Values::get_instance();
  values.delta_e_c_status.subscribe = 1;
  values.delta_e_status.publish = 1;
...
template <> UpModel ModelFactory::Generate<RROSACE::FlightDynamics, 1>() {
  auto &&values = Values::get_instance();
  values.delta_e_status.subscribe = 1;
  values.t_status.subscribe = 1;
  values.h_status.publish = 1;
  values.vz_status.publish = 1;
  values.va_status.publish = 1;
  values.q_status.publish = 1;
  values.az_status.publish = 1;
...
template <> UpModel ModelFactory::Generate<RROSACE::AltitudeFilter, 1>() {
  auto &&values = Values::get_instance();
  values.h_status.subscribe = 1;
  values.h_f_status.publish = 1;
...
UpModel ModelFactory::Generate<RROSACE::VerticalAirspeedFilter, 1>() {
  auto &&values = Values::get_instance();
  values.vz_status.subscribe = 1;
  values.vz_f_status.publish = 1;
...
template <> UpModel ModelFactory::Generate<RROSACE::TrueAirspeedFilter, 1>() {
  auto &&values = Values::get_instance();
  values.va_status.subscribe = 1;
  values.va_f_status.publish = 1;
...
template <> UpModel ModelFactory::Generate<RROSACE::PitchRateFilter, 1>() {
  auto &&values = Values::get_instance();
  values.q_status.subscribe = 1;
  values.q_f_status.publish = 1;
...
UpModel ModelFactory::Generate<RROSACE::VerticalAccelerationFilter, 1>() {
  auto &&values = Values::get_instance();
  values.az_status.subscribe = 1;
  values.az_f_status.publish = 1;
...
template <> UpModel ModelFactory::Generate<RROSACE::FlightControlUnit, 1>() {
  auto &&values = Values::get_instance();
  values.h_c_status.publish = 1;
  values.vz_c_status.publish = 1;
  values.va_c_status.publish = 1;
...
UpModel ModelFactory::Generate<RROSACE::FlightControlComputerCommand, 1>() {
  auto &&values = Values::get_instance();
  values.mode_status.subscribe = 1;
  values.h_f_status.subscribe = 1;
  values.vz_f_status.subscribe = 1;
  values.va_f_status.subscribe = 1;
  values.q_f_status.subscribe = 1;
  values.az_f_status.subscribe = 1;
  values.h_c_status.subscribe = 1;
  values.vz_c_status.subscribe = 1;
  values.va_c_status.subscribe = 1;
  values.delta_e_c_partial_1_status.publish = 1;
  values.delta_th_c_partial_1_status.publish = 1;
...
UpModel ModelFactory::Generate<RROSACE::FlightControlComputerMonitor, 1>() {
  ...
  values.vz_c_status.subscribe = 1;
  values.va_c_status.subscribe = 1;
  values.delta_e_c_partial_1_status.subscribe = 1;
  values.delta_th_c_partial_1_status.subscribe = 1;
  values.other_master_in_law_1_status.subscribe = 1;
  values.relay_delta_e_c_1_status.subscribe = 1;
  values.relay_delta_th_c_1_status.subscribe = 1;
  values.master_in_law_1_status.subscribe = 1;
  return std::make_unique<RROSACE::FlightControlComputer>(
      values.mode, values.h_f, values.vz_f, values.va_f, values.q_f,
      values.az_f, values.h_c, values.vz_c, values.va_c,
      values.delta_e_c_partial_1, values.delta_th_c_partial_1,
...
UpModel ModelFactory::Generate<RROSACE::FlightControlComputerCommand, 2>() {
  ...
  values.vz_c_status.subscribe = 1;
  values.va_c_status.subscribe = 1;
  values.delta_e_c_partial_2_status.publish = 1;
  values.delta_th_c_partial_2_status.publish = 1;
  return std::make_unique<RROSACE::FlightControlComputer>(
      values.mode, values.h_f, values.vz_f, values.va_f, values.q_f,
      values.az_f, values.h_c, values.vz_c, values.va_c,
...
UpModel ModelFactory::Generate<RROSACE::FlightControlComputerMonitor, 2>() {
  ...
  values.vz_c_status.subscribe = 1;
  values.va_c_status.subscribe = 1;
  values.delta_e_c_partial_2_status.subscribe = 1;
  values.delta_th_c_partial_2_status.subscribe = 1;
  values.other_master_in_law_2_status.subscribe = 1;
  values.relay_delta_e_c_2_status.subscribe = 1;
  values.relay_delta_th_c_2_status.subscribe = 1;
  values.master_in_law_2_status.subscribe = 1;
  return std::make_unique<RROSACE::FlightControlComputer>(
      values.mode, values.h_f, values.vz_f, values.va_f, values.q_f,
      values.az_f, values.h_c, values.vz_c, values.va_c,
      values.delta_e_c_partial_2, values.delta_th_c_partial_2,
...
template <> UpModel ModelFactory::Generate<RROSACE::Cables, 1>() {
  ...
  values.delta_e_c_partial_1_status.publish = 1;
  values.delta_th_c_partial_1_status.publish = 1;
  values.relay_delta_e_c_1_status.publish = 1;
  values.relay_delta_th_c_1_status.publish = 1;
  values.delta_e_c_partial_2_status.publish = 1;
  values.delta_th_c_partial_2_status.publish = 1;
  values.relay_delta_e_c_2_status.publish = 1;
  values.relay_delta_th_c_2_status.publish = 1;
  values.delta_e_c_status.subscribe = 1;
  values.delta_th_c_status.subscribe = 1;
